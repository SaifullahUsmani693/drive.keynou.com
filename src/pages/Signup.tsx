...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center" style={{ background: "var(--gradient-dark)" }}>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            {[
              ...
              <div key={s.l} className="glass rounded-lg p-3 text-center">
                <p className="font-display text-xl font-bold text-primary">{s.n}</p>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
          ...
          <Button variant="outline" className="w-full mb-4 h-11 gap-2" onClick={handleGoogle}>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="John Doe" value={name} onChange={(e) => setName(e.target.value)} className="h-11" required />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" placeholder="Min 8 characters" value={password} onChange={(e) => setPassword(e.target.value)} className="h-11" required />
            </div>
